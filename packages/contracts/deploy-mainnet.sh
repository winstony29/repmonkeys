...
# 🚀 WellSpace Contract Deployment Script for Base Mainnet
# This script deploys all wellness contracts to Base mainnet

set -e  # Exit on any error

echo "🚀 WellSpace Contract Deployment to Base Mainnet"
echo "================================================"
echo ""
...
# Deploy using the mainnet script
...
echo "2. Update your frontend .env file with the new addresses"
echo "3. Update packages/playground/.env with the new addresses"
